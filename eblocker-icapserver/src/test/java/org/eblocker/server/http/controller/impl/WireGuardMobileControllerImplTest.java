...
public class WireGuardMobileControllerImplTest {
    ...
    public void setup() throws URISyntaxException, IOException {
        ...
        Mockito.when(wireGuardMobileService.getWireGuardMappedPort()).thenReturn(51820);
    ...
    public void downloadClientConf() throws Exception {
        ...
        Mockito.when(wireGuardMobileService.generateClientConfiguration(device.getId(), "vpn.hh.eblocker.com", 51820)).thenReturn("test");
        ...
        Mockito.verify(wireGuardMobileService, Mockito.times(1)).generateClientConfiguration(device.getId(), "vpn.hh.eblocker.com", 51820);
    ...
    public void downloadClientConfWithoutCertifcatePresent() throws Exception {
        ...
        Mockito.when(wireGuardMobileService.generateClientConfiguration(device.getId(), "vpn.hh.eblocker.com", 51820))
                .thenReturn("test-xyz");
        Mockito.when(wireGuardMobileService.getServerHost()).thenReturn("vpn.hh.eblocker.com");
        Mockito.when(request.getHeader("deviceType")).thenReturn(OperatingSystemType.WINDOWS.toString());
        ...
        Mockito.verify(wireGuardMobileService).generateClientConfiguration(newDeviceId, "vpn.hh.eblocker.com", 51820);
        Mockito.verify(wireGuardMobileService).reloadServerConfiguration();
    }
    ...
    public void generateDownloadUrlTest() throws Exception {
        ...
        String expected = String.format("/api/adminconsole/wireguard/configurations/downloadClientConf/%s?deviceType=WINDOWS", deviceId);
