...
public class RoutingController {
    ...
    @Inject
    public RoutingController(@Named("wireguard.iproute2.rttables.file.path") String ipRouteRtTablesFile,
                             @Named("wireguard.iproute2.rttables.temp.result.file.path") String ipRouteRtTablesTempFile,
                             @Named("wireguard.iproute2.rttables.name.prefix") String ipRouteRtTablesTableNamePrefix,
                             @Named("wireguard.iproute2.rttables.offset") int ipRouteRtTablesOffset,
                             @Named("wireguard.iproute2.rttables.route.min") int ipRouteRtTablesRouteMin,
                             @Named("wireguard.iproute2.rttables.route.max") int ipRouteRtTablesRouteMax,
                             @Named("wireguard.reconfigure.routing.tables.command") String reconfigureRoutingTablesScript,
                             @Named("wireguard.reconfigure.policy") String reconfigurePolicyScript,
                             @Named("wireguard.set.client.route.command") String setClientRouteScript,
                             @Named("wireguard.set.client.route.ip6.command") String setClientRouteIp6Script,
